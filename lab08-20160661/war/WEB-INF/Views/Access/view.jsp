...
<div id="menu">
	...
	<div class="formulario">
		<h2>Access: <%=g.getId()%></h2>

	
	<form name="miFormulario" method="get" action="/access/add"
		...
		<input type="hidden" name="action" value="accesCreatedDo" />
			...
			<p>Role:</p>
			<input type="text" name="role"value=<%=g.getRole()%> readonly="readonly">
			<p>Resource:</p>
			<input type="text" name="resource"value=<%=g.getResource()%> readonly="readonly">
